...
#define COM_PORT 222
#define NO_ERROR 0
//parameter structure stores op code which is idle exit read or write.
//device_id number to the device such as com1 com2..
//buffer_ptr buffer to be used for storing read data or for writing data. Not used in idle or exit
//count_ptr stores # of bytes read/written to/ from the buffer
typedef struct {
  int op_code;
  int device_id;
  char *buffer_ptr;
